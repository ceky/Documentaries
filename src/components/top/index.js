...
const Top = () => (
  <div className="top-container">
    ...
    <ul className="top-list">
      <li>
        <TopMovie year={2013}>Blackfish</TopMovie>
      </li>
      <li>
        <TopMovie year={2005}>Earthlings</TopMovie>
      </li>
      <li>
        <TopMovie year={2016}>Before the Flood</TopMovie>
      </li>
      <li>
        <TopMovie year={2010}>Senna</TopMovie>
      </li>
      <li>
        <TopMovie year={2014}>
      ...
      <li>
        <TopMovie year={2002}>Shackleton's Voyage of Endurance</TopMovie>
      </li>
      <li>
        <TopMovie year={2010}>Happy People: A Year in the Taiga</TopMovie>
      </li>
      <li>
        <TopMovie year={2014}>The salt of the earth</TopMovie>
      </li>
      <li>
        <TopMovie year={2016}>
